...
function solarfam_page_navi($before = '', $after = '') {
	...
	echo $before.'<nav aria-label="Page navigation"><ul class="pagination pagination-lg justify-content-center">'."";
	if ($start_page >= 2 && $pages_to_show < $max_page) {
		$first_page_text = __( 'Primero', 'solarfam' );
		echo '<li class="page-item"><a class="page-link" href="'.get_pagenum_link().'" title="'.$first_page_text.'">'.$first_page_text.'</a></li>';
	}
	echo '<li class="page-item">';
	previous_posts_link( __('Anterior', 'solarfam') );
	echo '</li>';
	...
	echo '<li class="page-item">';
	next_posts_link( __('Siguiente', 'solarfam'), 0 );
	echo '</li>';
	if ($end_page < $max_page) {
		$last_page_text = __( 'Anterior', 'solarfam' );
